...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['WHO','bunker/PeePeePooPoo','Musician, Animator','https://twitter.com/RanMal300','fe3e3c'],
		    ...
		    ['PurSnake','bunker/Snake','Developer of Grafex Engine','https://github.com/PurpleSSSnake', 'C549DB'],
			[''],
			['Sponsors'],
			['Asy.mp4',   'bunker/sponsors/asu','Sponsor','', 'af3afe'],
			['Bico',      'bunker/sponsors/bico','Sponsor','', 'fe6165'],
			['Blebash',   'bunker/sponsors/blebash','Sponsor','', '3a7cff'],
			['Donatus',   'bunker/sponsors/donatus','Sponsor','', 'e2e2e2'],
			['DoomSlayer','bunker/sponsors/doomslayer','Sponsor','', '376a1e'],
			['Magnate',   'bunker/sponsors/magnate','Sponsor','', 'ffffff'],
			['Magomed',   'bunker/sponsors/magomed','Sponsor','', '7d0627'],
			...
			//Cuz we using week7 splashes BRUH - PurSnake  ['Keoiki',				'keoiki',			'Note Splash Animations',										'https://twitter.com/Keoiki_',			'D2D2D2'],
