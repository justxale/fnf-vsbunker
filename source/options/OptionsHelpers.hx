...
class OptionsHelpers
{
    ...
    public static var LanguagesArray = ['English', 'Русский'];
    //
    ...
    //
    /*public static function getLangID(id:Int)
    {
        return LanguagesArray[id];
    }
    static public function ChangeLang(id:Int)
    {
        ClientPrefs.curLang = getLangID(id);
    }*/
}